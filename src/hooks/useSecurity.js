...
Este aplicativo é para DEMONSTRAÇÃO/DESENVOLVIMENTO apenas.

❌ NÃO use com dados financeiros reais sem:
   1. Backend seguro com autenticação
   2. HTTPS obrigatório
   3. Encriptação de dados em repouso
   4. 2FA (autenticação de dois fatores)
   5. Pen testing regular

⚠️ RISCOS CONHECIDOS:
   • Sem proteção contra XSS em produção
   • Dados são lidos na memória do navegador
   • Sem encriptação de dados em repouso
   • Sem proteção contra roubo de sessão

📖 Veja SECURITY_AUDIT.md para detalhes completos.

✅ MELHORIAS IMPLEMENTADAS:
   • PBKDF2 hash de senha (100k iterações)
   • sessionStorage para dados sensíveis
   • Input sanitization básica
   • Rate limiting de login
   • Limpeza segura ao logout

🔐 Para dados reais → implemente um backend seguro!
  `)
}
